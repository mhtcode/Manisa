...
type AppointmentValue = { id: string; customerId: string; serviceIds: string[]; startAt: string; expectedDurationMinutes: number; expectedPrice: string; notes?: string | null };
