...
export const publicCopy = {
  en: {
    navServices: "Services", navWork: "Our work", navStudio: "The studio", navReviews: "Reviews", navLocation: "Location", login: "Login",
    ...
    ratingReviews: "approved reviews", studioKicker: "A private appointment, beautifully considered", studioTitle: "Slow beauty for busy lives.", studioBody: "Manisa is an appointment-only home studio for people who value relaxed care, precise technique, and results made personal.", appointmentOnly: "Appointment only",
  ...
  fa: {
    navServices: "خدمات", navWork: "نمونه‌کارها", navStudio: "استودیو", navReviews: "نظرها", navLocation: "موقعیت", login: "ورود",
    ...
    ratingReviews: "نظر تأییدشده", studioKicker: "قراری خصوصی با توجه به تمام جزئیات", studioTitle: "زیبایی آرام برای زندگی‌های پرمشغله.", studioBody: "مانیسا استودیویی خانگی و وقت‌محور برای کسانی است که به آرامش، ظرافت و نتیجه‌ای شخصی اهمیت می‌دهند.", appointmentOnly: "فقط با تعیین وقت",
