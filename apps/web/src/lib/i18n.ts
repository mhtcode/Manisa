...
const faPhrases: Record<string, string> = {
  ...
  "Each finalized visit is one album. Open an album to manage its photos.": "هر مراجعه نهایی‌شده یک آلبوم است. برای مدیریت تصاویر، آلبوم را باز کنید.", "Photos from one finalized visit.": "تصاویر یک مراجعه نهایی‌شده.", "All customers": "همه مشتریان", "Clear filters": "پاک کردن فیلترها", "No visit albums yet": "هنوز آلبوم مراجعه‌ای وجود ندارد", "Load older albums": "بارگذاری آلبوم‌های قدیمی", "Load older photos": "بارگذاری تصاویر قدیمی", "This album has no active photos.": "این آلبوم تصویر فعالی ندارد.", "Feature on website": "نمایش در وب‌سایت", "Remove from website": "حذف از وب‌سایت", "Featured on website": "نمایش داده‌شده در وب‌سایت", "Move to Trash": "انتقال به سطل زباله",
