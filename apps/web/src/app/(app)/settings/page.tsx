...
export default async function SettingsPage() {
  ...
  return <>
    ...
    <div className="mt-6 flex items-center justify-center gap-2 text-xs text-slate-600"><BrandLogo size={20}/>Manisa studio management</div>
  </>;
}
